        ...
        <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-md relative">
            ...
            <form className="my-8" onSubmit={handleSubmit}>
                ...
                <p className="text-sm text-black text-center mt-10">
                    New to <span className="text-[#635bff] font-semibold">Slotflow</span>? <span className="underline font-semibold" onClick={handleRegister}>{loginForm ? "Sign Up" : "Sign In"}</span>
                </p>
