...
const SideBar = ({ routes }: SideBarProps) => {
  ...
  return (
    <div className={` ${sidebarOpen ? 'w-[16%]' : 'w-[6%]'} h-auto bg-[var(--background)] shadow-[5px_0_0_0_rgba(0,0,0,0.2)] p-4 overflow-y-scroll transition-all duration-400 no-scrollbar border-r-2`}>
